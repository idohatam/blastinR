                      ...
                      reporting = TRUE, numt=1,...)
{
  ...
  if(reporting == TRUE){
    ...
    html_outputs_path <- paste0("outputs/reports/figures/",time[[1]],"_plot.html")
    figures_outputs_path <- paste0("figures/",time[[1]],"_plot.html")

    results_list <- list(data_table = table_outputs_full_path,
                         plot_table = figures_outputs_path,
